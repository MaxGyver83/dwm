...
static Key keys[] = {
	...
	{ ALT|WIN,                   XK_period, incrgaps,       {.i = -1 } },
	{ ALT|WIN,                   XK_u,      incrgaps,       {.i = +1 } },
...
static Button buttons[] = {
	...
	{ ClkStatusText,        0,           Button1,        spawn,          SHCMD("alacritty -d 82 9 -t Calendar -e sh -c 'ncal -bwM3 && printf \"Press Enter for closing \" && read'") },
